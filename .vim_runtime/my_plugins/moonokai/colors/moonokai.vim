...
hi Normal guifg=#f4f4f2 guibg=#272822 guisp=#272822 gui=NONE ctermfg=253 ctermbg=235 cterm=NONE
...
hi NonText guifg=#3B3A32 guibg=#3B3A32 guisp=#3B3A32 gui=NONE ctermfg=253 ctermbg=235 cterm=NONE
